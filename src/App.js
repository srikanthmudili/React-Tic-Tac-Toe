...
const App = () => {
	...
	return (
		<Container className="p-5">
			<h1 className="text-center text-white pt-4">TIC TAC TOE</h1>
			{winMessage ? (
				...
				<h1 className="text-center text-white pb-2">
					It's {isCross ? <FaTimes className="icons" /> : <FaRegCircle className="icons" />} turn
				</h1>
			)}
			...
			<h6 className="text-white text-center pt-3">By Srikanth Mudili</h6>
		</Container>
	);
};
